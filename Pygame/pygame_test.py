...
# Fonts
## Poppins
font_bold =  pygame.font.Font(pConvertFileName("Pygame/Fonts/Debrosee.ttf"), 48)
font_small =  pygame.font.Font(pConvertFileName("Pygame/Fonts/Nasa21.ttf"), 12)
font_bold_small =  pygame.font.Font(pConvertFileName("Pygame/Fonts/CabalBold.ttf"), 18)
font_default = pygame.font.Font(pConvertFileName("Pygame/Fonts/PixelFont.ttf"), 32) #Pixel Font
...
def draw_text(text, x, y, colour=colour_black, font=font_default, line_spacing=5):
    ...
    try:
        ...
        text_surface = font_default.render(text, True, colour)
...
def create_button(x=10, y=120, w=200, h=75, 
    ...
    heading_text_font : pygame.font.Font, optional
        The font of the heading text. Default is font_bold_small.
    ...
    body_text_font : pygame.font.Font, optional
        The font of the body text. Default is font_small.
...
def display_heading(title="Title", title_colour=colour_white, title_pos=(10, 10), title_font=font_bold, subtext="Subtext", subtext_colour=colour_white, subtext_pos=(10, 60), subtext_font=font_default):
    ...
    title_font : pygame.font.Font, optional
        The font of the title. Default is font_bold.
    ...
    subtext_font : pygame.font.Font, optional
        The font of the subtitle. Default is font_default.
